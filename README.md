...
Repository này lưu trữ website báo cáo thực tập của sinh viên **Phan Thị Hồng Nhiên** tại **Công ty TNHH Amazon Web Services Viet Nam**. Nội dung ghi lại hành trình học tập và thực hành AWS, quá trình nghiên cứu hệ thống Retrieval-Augmented Generation (RAG), triển khai nguyên mẫu **FCAJ RAG Chat**, các bài viết kỹ thuật, sự kiện đã tham gia, workshop thực hành, tự đánh giá và phản hồi sau chương trình.
...
| Thông tin | Chi tiết |
|---|---|
| Sinh viên | **Phan Thị Hồng Nhiên** |
| Mã số sinh viên | **3122411141** |
| Ngày sinh | **27/07/2004** |
| Số điện thoại | **0783872425** |
| Email | **phanthnhien27@gmail.com** |
...
|---|---|
| Sinh viên thực hiện | **Phan Thị Hồng Nhiên** |
| Mã số sinh viên | **3122411141** |
| Ngày sinh | **27/07/2004** |
| Số điện thoại | **0783872425** |
| Email | [phanthnhien27@gmail.com](mailto:phanthnhien27@gmail.com) |
| Chuyên gia hướng dẫn | Nguyễn Gia Hưng |
| Giảng viên hướng dẫn | Lê Nhị Lãm Thúy |
| Đơn vị thực tập | Công ty TNHH Amazon Web Services Viet Nam |
| Chương trình | Workforce Bootcamp — First Cloud AI Journey |
