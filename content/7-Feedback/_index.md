...
```mermaid
graph TD
    A[FCAJ 2026 8-Week Journey] --> B[Cloud Architecture Mindset]
    A --> C[Generative AI Mastery]
    A --> D[Hands-on Engineering Skills]
    A --> E[Professional Discipline]

    B --> B1[5 AWS Well-Architected Pillars]
    B --> B2[FinOps Cost Governance & Budget Caps]
    B --> B3[Least-Privilege Security Models]

    C --> C1[Kotaemon RAG Pipeline Design]
    C --> C2[Google Gemini API Integration]
    C --> C3[ChromaDB & LanceDB Vector Indexing]

    D --> D1[Docker Containerization & Shell Scripting]
    D --> D2[Persistent EBS gp3 Storage & S3 Backup]
    D --> D3[CloudWatch Monitoring & Systematic RCA]

    E --> E1[Self-Directed Research Discipline]
    E --> E2[Bilingual Workshop Documentation]
    E --> E3[Milestone Accountability & Ownership]
```
