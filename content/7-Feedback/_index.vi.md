...
```mermaid
graph TD
    A[Hành trình 8 tuần FCAJ 2026] --> B[Tư duy Kiến trúc Cloud]
    A --> C[Làm chủ Công nghệ AI Mới]
    A --> D[Kỹ năng Kỹ sư Thực chiến]
    A --> E[Tác phong Nghề nghiệp]

    B --> B1[5 Trụ cột AWS Well-Architected]
    B --> B2[Quản trị chi phí FinOps & Giới hạn Ngân sách]
    B --> B3[Bảo mật phân quyền Least Privilege]

    C --> C1[Kiến trúc RAG trên nền tảng Kotaemon]
    C --> C2[Tích hợp Google Gemini API]
    C --> C3[Lập chỉ mục Vector ChromaDB & LanceDB]

    D --> D1[Đóng gói Container Docker & Shell Script]
    D --> D2[Lưu trữ bền vững EBS & Sao lưu S3]
    D --> D3[Giám sát CloudWatch & Chẩn đoán lỗi RCA]

    E --> E1[Năng lực tự học & nghiên cứu chủ động]
    E --> E2[Biên soạn tài liệu Workshop song ngữ]
    E --> E3[Trách nhiệm và cam kết tiến độ]
```
